...
fn convert_op_class(from_db: OperatorClassWalker<'_>) -> dml::OperatorClass {
    match from_db.get() {
        ...
        Either::Left(db::OperatorClass::CharBloomOps) => dml::OperatorClass::CharBloomOps,
        Either::Left(db::OperatorClass::CharMinMaxOps) => dml::OperatorClass::CharMinMaxOps,
        ...
        Either::Left(db::OperatorClass::UuidMinMaxMultiOps) => dml::OperatorClass::BitMinMaxOps,
